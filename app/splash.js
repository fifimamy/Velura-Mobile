...
export default function SplashScreen() { 
  ...
  useEffect(() => { 
    ...
    playSound(); const timer = setTimeout(() => { 
      ...
      const [loaded] = useFonts({ Estedad: require('../assets/fonts/Estedad-VariableFont_wght.ttf'), 
        PlayfairDisplay: require('../assets/fonts/PlayfairDisplay-VariableFont_wght.ttf'), 
        Estedad: require('../assets/fonts/Estedad-VariableFont_wght.ttf'), 
      }); 
        return (
        <ImageBackground source={require('../assets/images/background1.png')} style={{ flex: 1 }}  resizeMode="cover" >
        <View 
         style={{ 
          ...
          <Text style ={{ fontWeight: "100", color: "#688f82", lineHeight : 20, position: 'absolute', bottom: -70, right: -150, width: 500, height: 100, justifyContent :"center", alignContent :"center", fontFamily: "PlayfairDisplay" }} >
